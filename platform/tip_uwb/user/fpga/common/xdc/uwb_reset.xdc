...
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { uwb_reset }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
...
set_property PULLUP true [get_ports uwb_reset ]
set_property PULLUP true [get_ports uart_readymade_tx_list[0] ]
